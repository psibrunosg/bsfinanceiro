...
## Corpus Check
- 25 files · ~2,663 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 162 nodes · 183 edges · 18 communities (12 shown, 6 thin omitted)
...
3. `Design System Master File` - 7 edges
4. `scripts` - 6 edges
5. `public.workspaces` - 5 edges
6. `include` - 5 edges
7. `BS Financeiro` - 5 edges
8. `Global Rules` - 5 edges
9. `Component Specs` - 5 edges
10. `completeOnboarding()` - 4 edges
...
## Knowledge Gaps
- **77 isolated node(s):** `compat`, `config`, `config`, `nextConfig`, `name` (+72 more)
